...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Waš wobhladowak ({browserName}) so wjace njepodpěruje wot EAden.",
        description:
            "Waš wobhladowak je přestarši, zo by EAden wuwjedł. Prošu aktualizujće jón na najnowšu wersiju, zo byšće pokročowali.",
        whatToDo: "Što móžeće činić?",
        option1: "{browserName} na najnowšu wersiju aktualizować",
        option2: "EAden wopušćić a druhi wobhladowak wužiwać",
        updateBrowser: "Wobhladowak aktualizować",
        leave: "Wopušćić",
    },
    pwaInstall: {
        title: "EAden instalować",
        description:
            "Instalujće app za lěpše dožiwjenje: spěšny přistup, start při startowanju a dožiwjenje kaž w app.",
        descriptionIos: "Přidajće EAden na swój startowy wobraz za lěpše dožiwjenje a spěšny přistup.",
        feature1Title: "Spěšny přistup",
        feature1Description: "Startujće EAden ze startoweho menija, Docka abo z desktopa.",
        feature2Title: "Swójske wokno app",
        feature2Description:
            "Dźeržće EAden wot browserowych rajtarkow dźělene a namakajće jo spěšnje w swojej nadawkowej lajsće.",
        feature3Title: "Z wašim kompjutorom startować",
        feature3Description: "Startujće EAden, hdyž so waš grat startuje.",
