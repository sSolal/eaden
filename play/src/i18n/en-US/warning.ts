...
const warning: BaseTranslation = {
    ...
    browserNotSupported: {
        ...
        message: "Your browser ({browserName}) is no longer supported by EAden.",
        description: "Your browser is too old to run EAden. Please update to the latest version to continue.",
        whatToDo: "What can you do?",
        option1: "Update {browserName} to the latest version",
        option2: "Leave EAden and use a different browser",
    ...
    pwaInstall: {
        ...
        descriptionIos: "Add EAden to your Home Screen for a better experience and quick access.",
        feature1Title: "Quick access",
        feature1Description: "Launch EAden from your Start menu, Dock, or desktop.",
        feature2Title: "Dedicated app window",
        feature2Description:
            "Keep EAden separate from your browser tabs and find EAden at a glance in your taskbar.",
        feature3Title: "Start with your computer",
        feature3Description: "Launch EAden when your device starts.",
