...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "المتصفح الخاص بك ({browserName}) لم يعد مدعوماً من EAden.",
        description: "متصفحك قديم جداً لتشغيل EAden. يرجى تحديثه إلى أحدث إصدار للمتابعة.",
        whatToDo: "ماذا يمكنك أن تفعل؟",
        option1: "تحديث {browserName} إلى أحدث إصدار",
        option2: "مغادرة EAden واستخدام متصفح مختلف",
    ...
    pwaInstall: {
        ...
        descriptionIos: "أضف EAden إلى الشاشة الرئيسية للحصول على تجربة أفضل ووصول سريع.",
        feature1Title: "وصول سريع",
        feature1Description: "شغّل EAden من قائمة ابدأ أو الـ Dock أو سطح المكتب.",
        feature2Title: "نافذة تطبيق مستقلة",
        feature2Description: "أبقِ EAden منفصلًا عن علامات تبويب المتصفح واعثر عليه بسرعة في شريط المهام.",
        feature3Title: "ابدأ مع تشغيل الجهاز",
        feature3Description: "شغّل EAden عند بدء تشغيل جهازك.",
